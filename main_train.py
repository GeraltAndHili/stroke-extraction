...
class MainTrain():
    def __init__(self, dataset='npz_4_1'):
        '''
    ...
    def train(self):
        # train SDNet
        self.train_sdnet.train_model(epochs=40, init_learning_rate=0.0001, batch_size=4)
        ...
        self.train_extractnet.evaluate_model(dataset='dataset_forSegNet_ExtractNet_'+self.dataset, split='test')
        print('ExtractNet training has been completed')


if __name__ == '__main__':
    train_ = MainTrain(dataset='npz_4_1')
    train_.train()
